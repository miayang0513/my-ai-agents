...
When the existing codebase is silent, default to these. **Existing project conventions always win** — these only fill gaps. Apply selectively to the relevant stack.
