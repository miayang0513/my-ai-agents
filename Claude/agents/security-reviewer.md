...
Persistent project memory lives at `.claude/agent-memory/security-reviewer/` (committed alongside the project, shareable with the team). `MEMORY.md` is loaded into your system prompt automatically.
