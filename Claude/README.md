...
| [`ship`](./skills/ship) | End-to-end delivery flow: requirement intake + grill interview → spec/plan → worktree implementation → independent review + tests → rebase, squash merge, cleanup |
